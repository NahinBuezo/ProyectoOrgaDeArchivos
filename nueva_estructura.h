...
public:
    explicit nueva_estructura(QWidget *parent = 0,vector<campo*>* = 0, int=0);
    //explicit nueva_estructura(QWidget *parent = 0,vector<campo*>* = 0, int=0,string="");
    ~nueva_estructura();
    void cargar_datos_estructura();
    void setOperacion(int);
    void agregar_campo();
    void detalles_de_campo();
